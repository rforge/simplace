...
# Introduction
This package provides methods to interact with the modelling framework <span style="font-variant:small-caps;">Simplace
</span>^[**S**<span style="font-variant:small-caps;">cientific</span> 
...
```{r running, results='hide', eval=FALSE}
library(simplace)
SimplaceInstallationDir <- "D:/Java/simplace/"
SimplaceWorkDir <- paste(SimplaceInstallationDir,"simplace_run/simulation/",sep="")
SimplaceOutputDir <-  paste(SimplaceInstallationDir,"simplace_run/output/",sep="")
...
```{r plotting, fig.height=5, fig.width=6, eval=FALSE}
...
```{r contourplot, fig.height=5, fig.width=6, eval=FALSE}
